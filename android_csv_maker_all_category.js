...
var file = "android_category_all.csv";
...
//  var cursor = android.find({$or: [{"category":"Cards and Casino"}, {"category": "Cards & Casino"}]});
  var cursor = android.find({"category":"Weather"});
  file = "android_all_weather.csv"
